...
suite "func updatedAtFormat":
  ...
  let test1 = fmt"""{currentTimeStamp1} it returns '26/Jun/2022 10:54:12' """

  let currentTimeStamp2: string = "Sat, 18 Jun 2022 05:46:51 Z"
  let test2 = fmt"""{currentTimeStamp2} it returns '18/Jun/2022 05:46:51' """

  let currentTimeStamp3: string = "Fri, 17 Jun 2022 04:16:12 Z"
  let test3 = fmt"""{currentTimeStamp3} it returns '17/Jun/2022 04:16:12' """

  let currentTimeStamp4: string = "Fri, 01 Jul 2022 05:25:00 Z"
  let test4 = fmt"""{currentTimeStamp3} it returns '01/Jul/2022 05:25:00' """
  ...
  suite "when date is:":
    ...
    test test4:
      check updatedAtFormat(currentTimeStamp4) == "01/Jul/2022 05:25:00"
